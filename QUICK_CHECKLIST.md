...
2. [ ] Open this URL in browser:
   ```
   https://ecommerce-site-backend-oriu.vercel.app/api/v1/products
   ```
...
```bash
# Categories
https://ecommerce-site-backend-oriu.vercel.app/api/v1/categories

# Brands
https://ecommerce-site-backend-oriu.vercel.app/api/v1/brands

# Banners
https://ecommerce-site-backend-oriu.vercel.app/api/v1/banners
```

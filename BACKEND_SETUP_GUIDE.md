...
```bash
curl https://ecommerce-site-backend-oriu.vercel.app/api/v1/health
# or
curl https://ecommerce-site-backend-oriu.vercel.app/
```
...
- [ ] Test endpoint returns data: `curl https://ecommerce-site-backend-oriu.vercel.app/api/v1/products`
...
curl https://ecommerce-site-backend-oriu.vercel.app/api/v1/categories

# Test 3: Get brands
curl https://ecommerce-site-backend-oriu.vercel.app/api/v1/brands

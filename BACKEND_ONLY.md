...
**Production Backend:** `https://ecommerce-site-backend-blue.vercel.app/api/v1`
...
### Authentication
```
Login → POST https://ecommerce-site-backend-blue.vercel.app/api/v1/auth/signin
Register → POST https://ecommerce-site-backend-blue.vercel.app/api/v1/auth/signup
```
...
```bash
curl https://ecommerce-site-backend-blue.vercel.app/api/v1/banners
```
